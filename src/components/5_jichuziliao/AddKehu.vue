              ...
              <el-col :span="5">
                <el-form-item label="属性代码：">
                  <el-select
                    filterable
                    size="small"
                    v-model="addForm.attribute_codeid"
                    placeholder="请选择"
                  >
                    <el-option
              ...
              <el-col :span="5">
                <el-form-item label="结算货币：">
                  <el-select
                    filterable
                    size="small"
                    v-model="addForm.settlement_currencyid"
                    placeholder="请选择"
                  >
                    <el-option
                  ...
                  <el-row>
                    <el-col :span="6">
                      <el-input
                        size="small"
                        placeholder="国家"
                        v-model="addForm2.country_name"
                      ></el-input>
                    </el-col>
                    <el-col style="margin-left: 10px" :span="8">
                      <el-input
                        size="small"
                        placeholder="省份/自治区/州"
                        v-model="addForm2.province_name"
                      ></el-input>
                    </el-col>
                    <el-col style="margin-left: 10px" :span="8">
                      <el-input
                  ...
                  <el-row>
                    ...
                    <el-col style="margin-left: 10px" :span="8">
                      <el-input
                        size="small"
                        placeholder="传真分机号"
                        v-model="addForm2.extension_number"
                      ></el-input>
                    </el-col>
                  </el-row>
                </el-form-item>
            ...
            <el-row :gutter="10">
              ...
              <el-col :span="5">
                <el-form-item label="拖欠限额：">
                  <el-input
                    size="small"
                    v-model="addForm2.delinquency_limit"
                  ></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="10">
              <el-col :span="5">
                <el-form-item label="固定联系人：">
                  <el-input
                    size="small"
                    v-model="addForm2.fixed_contact"
                  ></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="5">
                <el-form-item label="对账联系人：">
                  <el-input
                    size="small"
                    v-model="addForm2.reconciliation_contact"
                  ></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="5">
                <el-form-item label="发票收寄联系人：">
                  <el-input
                    size="small"
                    v-model="addForm2.invoice_receiving"
                  ></el-input>
                </el-form-item>
              </el-col>
            </el-row>
              ...
              <vxe-table :data="tableData1">
                ...
                <vxe-table-column field="swi1" width="100" title="有效">
                  <template slot-scope="scope">
                    <el-switch
                      @change="changeSw1(scope.row, scope.rowIndex)"
              ...
              <el-col :span="5">
                <el-form-item label="货主属性：">
                  <el-select
                    ...
                    filterable
                    size="small"
                    v-model="addForm3.owner_attribute"
                    placeholder="请选择"
                  >
                    <el-option label="中国-CN-China" value="China"></el-option>
                    <el-option
              ...
              <el-col :span="5">
                <el-form-item label="客服：">
                  <el-select
                    ...
                    filterable
                    size="small"
                    v-model="addForm3.customer_serviceid"
                    placeholder="请选择"
                  >
                    <el-option
                      v-for="item in YWYList"
              ...
              <el-col :span="20">
                <el-form-item label="费用优惠说明：">
                  <el-input
                    type="textarea"
                    size="small"
                    v-model="addForm3.fee_preference"
                    :rows="5"
                  ></el-input>
                </el-form-item>
              </el-col>
              ...
              <vxe-table-column title="操作状态" width="120">
                <template slot-scope="scope">
                  <div class="flex">
                    <el-button
                      size="small"
                      @click="toEdit2(scope.row, scope.rowIndex)"
                      type="text"
                      >编辑</el-button
                    >
                    <el-button
                      size="small"
                      @click="toDel2(scope.rowIndex)"
                      type="text"
                      >删除</el-button
                    >
                  </div>
              ...
              <vxe-table-column title="操作状态" width="120">
                <template slot-scope="scope">
                  <div class="flex">
                    <el-button
                      size="small"
                      @click="toEdit3(scope.row, scope.rowIndex)"
                      type="text"
                      >编辑</el-button
                    >
                    <el-button
                      size="small"
                      @click="toDel3(scope.rowIndex)"
                      type="text"
                      >删除</el-button
                    >
                  </div>
      ...
      <div class="myAddForm">
        ...
        >
          ...
          <el-row>
            <el-col :span="20">
              <el-form-item>
                <el-button size="small" @click="addDialogVisible2 = false"
                  >取消</el-button
                >
                <el-button size="small" type="primary" @click="AddDiaOnSubmit2"
                  >确定</el-button
                >
              </el-form-item>
            </el-col>
      ...
      <div class="myAddForm">
        ...
        >
          ...
          <el-row>
            <el-col :span="20">
              <el-form-item>
                <el-button size="small" @click="addDialogVisible3 = false"
                  >取消</el-button
                >
                <el-button size="small" type="primary" @click="AddDiaOnSubmit3"
                  >确定</el-button
                >
              </el-form-item>
            </el-col>
